...
$(function() {
	...
	if (ain[0].length>=50) ain[0] = ain[0].splice(1);
	if (ain[1].length>=50) ain[1] = ain[1].splice(1);
	if (ain[2].length>=50) ain[2] = ain[2].splice(1);
	if (ain[3].length>=50) ain[3] = ain[3].splice(1);
